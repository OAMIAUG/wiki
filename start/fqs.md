...
在客户端多人游戏中添加服务器的主用地址 `play.imyvm.com` 或 `main.imyvm.com`。如果出现「无法解析」、「Unknown host」等问题，请点击刷新按钮或者尝试使用服务器地址的备用地址。同时，将鼠标移动到信号标识符上可查看延迟。如在游戏中出现延迟较高、丢包严重等影响游戏体验的现象，可联系管理员协助处理。
